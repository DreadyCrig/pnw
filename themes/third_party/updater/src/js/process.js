;(function(global, $){
    ...
    function backupDbTables(index) {
        ...
        var params = Updater.getDefaultParams();
        params.time = backupDate;
        params.table=  backupTables[index];
        params.action = 'backup';
    ...
    function startGeneralAction(id) {
        ...
        var params = Updater.getDefaultParams();
        params.addon = JSON.stringify(currentAction);
    ...
    function eeUpdateInit(id) {
        ...
        var params = Updater.getDefaultParams();
        params.action =  'site_offline';
        params.action_obj =  JSON.stringify(currentAction);
    ...
    function eeUpdate(index) {
        ...
        $.ajax({url: eeInstallerUrl + 'update_ee/'+ eeUpdates[index].version + '/' + Updater.generateRandomString(),
            ...
            data: {
                ...
                update_file: eeUpdates[index].file,
                action_obj: JSON.stringify(currentAction),
                server: eeServer
            },
            error: function(xhr){
