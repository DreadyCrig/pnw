...
class Updater_ee
{
    ...
    public function copyInstaller($action_obj)
    {
        ...
        try
        {
            ...
            // Transfer all errors (just in case)
            $this->EE->updater_transfer->upload('system', $root.'system/installer/errors', 'installer/errors', 'dir', TRUE);
            ...
            // Libraries Folder
            $this->EE->updater_transfer->mkdir('system', 'installer/libraries'); // mkdir it, just in case
            ...
            // Models folder
            if (file_exists($root.'system/installer/models/') === true) {
                $this->EE->updater_transfer->mkdir('system', 'installer/models'); // mkdir it, just in case

                foreach (scandir($root.'system/installer/models/') as $file) {
                    if ($file == '.' || $file == '..') continue;

                    $this->EE->updater_transfer->upload('system', $root.'system/installer/models/'.$file, 'installer/models/'.$file, 'file', true);
                }
            }
