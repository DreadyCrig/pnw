...
class Wgt_cp_analytics_chart
{
	...
	{	
		...
		$this->settings = array(
			'title' => $this->EE->lang->line('wgt_cp_analytics_chart_widget_title'),
			'days' => '30'
		);
		$this->title  	= $this->EE->lang->line('wgt_cp_analytics_chart_widget_title');
	...
	public function index($settings = NULL)
	{
		...
		$vars = array(
			'chart' => cp_analytics_chart_data($data['lastmonth']['daily_stats'], $settings->days),
			'show_every' => ($settings->days == '30') ? '6' : '4',
