<form method="post" action="<?=$base_url?>&amp;method=save_settings" class="low-form">
	...
	<table cellpadding="0" cellspacing="0" class="mainTable">
		<caption><?=lang('global_settings')?></caption>
		<colgroup>
			<col style="width:50%" />
			<col style="width:50%" />
		</colgroup>
		...
		<tbody>
			...
			<td class="multiple">
					<label><?=lang('filters')?></label>
					<p><?=lang('filters_help')?></p>
				</td>
				<td class="low-box-list">
					<?php foreach ($filters AS $filter): ?>
						<label>
							<input type="checkbox" name="filters[]" value="<?=$filter?>"<?php if ( ! in_array($filter, $disabled_filters)): ?> checked="checked"<?php endif; ?> />
	...
	<table cellpadding="0" cellspacing="0" class="mainTable">
		<caption><?=lang('keywords_settings')?></caption>
		<colgroup>
			<col style="width:50%" />
			<col style="width:50%" />
		</colgroup>
